---
name: lark-base
description: "LarkSuite Bitable database management - tables, records, fields, views, permissions.
Use when user asks about database, bitable, base, table, record, field, view, permission,
ERD, schema, data entry, batch import, role, collaborator. Requires lark-token-manager MCP."
---
