...
|--------|-------------|------------|
| Calendar | v4 | `calendar:calendar` |
| Task | v2 | `task:task:write`, `task:tasklist:write`, `task:section:write` |
| Contacts | v3 | `contact:user.base:readonly` |
| Base (Bitable) | v1 | `bitable:app` |
| Docs (DOCX) | v1 | `docx:document` |
| Drive | v1 | `drive:drive`, `drive:file` |
| Sheets | v3 | `sheets:spreadsheet` |
| Messenger (IM) | v1 | `im:message`, `im:chat` |
