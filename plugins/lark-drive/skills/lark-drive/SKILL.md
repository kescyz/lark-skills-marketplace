---
name: lark-drive
description: "LarkSuite Drive file management — upload, download, folders, permissions, search.
Use when user asks about drive, file, upload, download, folder, share, permission, storage,
attachment, document management. Requires lark-token-manager MCP."
---
...
- Lark app scopes: `drive:drive` (full CRUD), `drive:file` (upload/download)
...
- **Download binary only**: doc/sheet/docx/bitable NOT downloadable — use export instead
