...
description: "Lark Base formula reference — 100+ functions, cross-table patterns, syntax, errors.
Use when user asks about Base formulas, Bitable formulas, formula functions, formula errors,
calculated fields, cross-table references, CurrentValue, formula optimization.
Does NOT call APIs — pure knowledge reference. For Base CRUD, use lark-base skill."
---
